    ...
    constructor() {
        super({
            ...
            uniforms: {
                ...
                // t: { type: "t", value: getVideoTexture() },
            ...
            void main() {
              vUv = uv;
              vec3 distortion1 = vec3(position.x*1.,position.y*2.,2.) * snoiseVec3Abs(vec3(
              position.x*0.002 + time*0.002,
              position.y*0.08 + time*0.002,
              (position.x) * 0.2
              ))*(distortion*2.1);
          ...
          `,
            ...
            void main() {
              ...
              gl_FragColor = vec4(tt[0], tt[1], tt[2], opacity);
              
              if (tt.r<0.1 && tt.b<0.1 && tt.g<0.1) discard;
            }
          `
        })
    }
